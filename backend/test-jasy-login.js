...
async function testJasyLogin() {
  try {
    console.log('🔐 Testing Jasy login and test result access...\n');
    
    // 1. Login as Jasy
    console.log('1️⃣ Logging in as jasy@gmail.com...');
    const loginResponse = await axios.post('http://localhost:5000/api/auth/login', {
      identifier: 'jasy@gmail.com',
    ...
    if (loginResponse.data.success) {
      ...
      console.log('\n2️⃣ Fetching Jasy\'s test results...');
      ...
      if (resultsResponse.data.success) {
        ...
        if (resultsResponse.data.count > 0) {
          ...
          console.log('\n🎉 SUCCESS! Jasy can now see her test results in the patient portal!');
        } else {
          console.log('\n❌ No test results found for Jasy');
        }
      } else {
